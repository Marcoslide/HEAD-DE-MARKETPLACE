...
| 6 · Experiência | ✅ **fundada** · +Chat operacional (S09.A) | `docs/01–05` + `design/prototipo-v2` + `design/prototipo-v3` (Plano do Dia do EPE, navegável) + [**Head Chat**](docs/head-conversational-operating-intelligence.md): perguntas operacionais respondidas na hora por intenção + consulta tipada + fonte declarada (fixtures agora, Central depois — mesmo contrato) |
