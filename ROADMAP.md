...
| 4 · Cognitiva | ✅ **fundada** · +Specialists Engine (Sprint 06) | [`mie/`](mie/README.md) — 7 motores + [Specialists Engine](docs/specialists-engine.md) (conselho, votação ponderada, memória de acertos) + playbooks + Debug Console |
